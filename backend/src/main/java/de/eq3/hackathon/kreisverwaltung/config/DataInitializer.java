...
public class DataInitializer implements CommandLineRunner {
        ...
        private void createUsers() {
                ...
                users.add(createUser("behoerde.wirtschaft", "daten@mw.niedersachsen.de", "wirtschaft123",
                                User.Role.USER,
        ...
        private void createDatasources() {
                ...
                // Get users who will be owners
                User providerLeer = userRepository.findByUsername("provider.leer").orElse(null);
                User providerAurich = userRepository.findByUsername("provider.aurich").orElse(null);
                User providerWittmund = userRepository.findByUsername("provider.wittmund").orElse(null);
                User providerEmden = userRepository.findByUsername("provider.emden").orElse(null);
                ...
                User businessTourismus = userRepository.findByUsername("business.tourismus").orElse(null);
                User businessEnergie = userRepository.findByUsername("business.energie").orElse(null);
                ...
                User ngoTransparenz = userRepository.findByUsername("ngo.transparenz").orElse(null);
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.GOVERNMENT, Datasource.DataFormat.CSV,
                                Datasource.AccessLevel.PUBLIC,
                                ...
                                Map.of("Messstandorte", "15 Zählstellen", "Zeitraum", "Seit 2020", "Format",
                                                "CSV mit Zeitstempel"),
                                providerLeer));
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.GOVERNMENT, Datasource.DataFormat.JSON,
                                Datasource.AccessLevel.PUBLIC,
                                ...
                                Map.of("Aktualisierung", "Quartalsweise", "Granularität", "Ortsteile", "Zeitreihe",
                                                "Seit 2010"),
                                providerAurich));
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.GOVERNMENT, Datasource.DataFormat.SHAPEFILE,
                                Datasource.AccessLevel.PUBLIC,
                                "energie@ostfriesland.de", "Energieagentur Ostfriesland", "Landkreise Ostfriesland",
                                "https://gis.ostfriesland.de/windenergie/anlagen.shp",
                                "https://energie-ostfriesland.de/daten-docs",
                                "Monatlich", "CC-BY 4.0", false, null,
                                Datasource.DataSensitivity.PUBLIC, null,
                                List.of("Windenergie", "Erneuerbare Energie", "GIS", "Ostfriesland", "Klimaschutz"),
                                Map.of("Anlagen", "2.847 WEA", "Gesamtleistung", "4.200 MW", "Koordinatensystem",
                                                "EPSG:25832"),
                                admin));
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.GOVERNMENT, Datasource.DataFormat.REST_API,
                                Datasource.AccessLevel.RESTRICTED,
                                ...
                                Datasource.DataSensitivity.RESTRICTED,
                                "Umwelt-Behördenzertifikat oder Umweltforschung erforderlich",
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.GOVERNMENT, Datasource.DataFormat.DATABASE,
                                Datasource.AccessLevel.RESTRICTED,
                                "statistik@polizei-ol.niedersachsen.de", "Kriminalhauptkommissar Werner Janssen",
                                "Polizeidirektion Oldenburg",
                                "https://secure-api.polizei-nds.de/statistik/ostfriesland",
                                "https://polizei-nds.de/statistik-docs",
                                "Monatlich", "Polizeilizenz", true,
                                List.of(Certificate.CertificateType.GOVERNMENT_GENERAL,
                                                Certificate.CertificateType.RESEARCH_SOCIAL),
                                Datasource.DataSensitivity.CONFIDENTIAL,
                                "Behördenzertifikat oder Kriminologie-Forschung erforderlich",
                                List.of("Kriminalität", "Sicherheit", "Statistik", "Polizei", "Anonymisiert"),
                                Map.of("Deliktgruppen", "15 Kategorien", "Räumliche Auflösung", "Gemeinde-Ebene",
                                                "Anonymisierung",
                                                "K-Anonymität k=5"),
                                admin));
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.GOVERNMENT, Datasource.DataFormat.JSON,
                                Datasource.AccessLevel.PRIVATE,
                                "statistik@klinikum-emden.de", "Prof. Dr. Hans Mueller", "Klinikum Emden",
                                "https://secure.klinikum-emden.de/api/statistics",
                                "https://forschung.klinikum-emden.de/docs",
                                "Monatlich", "Medizinische Forschungslizenz", true,
                                List.of(Certificate.CertificateType.GOVERNMENT_HEALTH,
                                                Certificate.CertificateType.RESEARCH_HEALTH,
                                                Certificate.CertificateType.PROFESSIONAL_DOCTOR),
                                Datasource.DataSensitivity.CLASSIFIED,
                                "Nur für Gesundheitsbehörden, medizinische Forschung oder Ärzte",
                                List.of("Gesundheit", "Epidemiologie", "Anonymisiert", "Forschung", "Medizin",
                                                "Klinik"),
                                Map.of("Behandlungsfälle", "~15.000/Jahr", "Anonymisierung", "HIPAA-konform",
                                                "Ethikkommission",
                                                "Genehmigt"),
                                providerEmden));
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.BUSINESS, Datasource.DataFormat.EXCEL,
                                Datasource.AccessLevel.PUBLIC,
                                ...
                                Map.of("Betriebe", "347 Beherbergungsbetriebe", "Betten", "28.450 Betten", "Saison",
                                                "April-Oktober"),
                                businessTourismus));
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.BUSINESS, Datasource.DataFormat.REST_API,
                                Datasource.AccessLevel.RESTRICTED,
                                "daten@lwk-niedersachsen.de", "Dr. Agrar Johann Hinrichs",
                                "Landwirtschaftskammer Niedersachsen",
                                "https://api.lwk-nds.de/ostfriesland/betriebe",
                                "https://lwk-nds.de/daten-dokumentation",
                                ...
                                Datasource.DataSensitivity.CONFIDENTIAL,
                                "Agrarforschung oder Behördliche Statistik erforderlich",
                                List.of("Landwirtschaft", "Agrar", "Betriebe", "Ostfriesland", "Anonymisiert"),
                                Map.of("Betriebe", "~3.200 Betriebe", "Hauptkulturen", "Grünland, Mais, Getreide",
                                                "Tiere",
                ...
                datasources.add(createDatasource(
                                ...
                                "https://opendata.dwd.de/climate/observations/hourly/norderney",
                                "https://dwd.de/klimadaten-docs",
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.SCIENCE, Datasource.DataFormat.DATABASE,
                                Datasource.AccessLevel.RESTRICTED,
                                ...
                                Datasource.DataSensitivity.RESTRICTED,
                                "Meeresforschung oder Universitäre Umweltforschung erforderlich",
                                List.of("Wattenmeer", "Sediment", "Meeresforschung", "Geochemie", "ICBM",
                                                "Schadstoffe"),
                                Map.of("Probenpunkte", "156 Stationen", "Parameter", "35 chemische Parameter",
                                                "Zeitreihe",
                                                "Seit 1995"),
                                forscher));
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.CIVIL_SOCIETY, Datasource.DataFormat.CSV,
                                Datasource.AccessLevel.PUBLIC,
                                "info@transparenz-ostfriesland.de", "Bürgerinitiative Transparenz",
                                "Transparenz Ostfriesland e.V.",
                                "https://transparenz-of.de/data/lobbyisten.csv",
                                "https://transparenz-of.de/dokumentation",
                                "Wöchentlich", "CC-BY 4.0", false, null,
                                Datasource.DataSensitivity.PUBLIC, null,
                                List.of("Transparenz", "Politik", "Lobbyismus", "Bürgerbeteiligung", "Demokratie"),
                                Map.of("Lobbyisten", "127 registrierte Personen", "Themen",
                                                "Energie, Verkehr, Tourismus", "Update",
                                                "Bei Neuanmeldungen"),
                                admin));
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.CIVIL_SOCIETY, Datasource.DataFormat.JSON,
                                Datasource.AccessLevel.PUBLIC,
                ...
                datasources.add(createDatasource(
                                ...
                                Datasource.Category.CIVIL_SOCIETY, Datasource.DataFormat.EXCEL,
                                Datasource.AccessLevel.RESTRICTED,
                                ...
                                List.of(Certificate.CertificateType.NGO_SOCIAL,
                                                Certificate.CertificateType.RESEARCH_SOCIAL),
                                Datasource.DataSensitivity.CONFIDENTIAL,
                                "Sozialforschung oder NGO-Zertifikat erforderlich",
                                List.of("Soziales", "Hilfeleistungen", "Anonymisiert", "Diakonie", "Gesellschaft"),
                                Map.of("Beratungsfälle", "~8.500/Jahr", "Hilfebereiche", "12 Kategorien",
                                                "Anonymisierung",
                                                "Streng nach DSGVO"),
                                ngoSozial));
        ...
        // Main method with owner parameter
        private Datasource createDatasource(String title, String description, Datasource.Category category,
                        ...
                        List<String> tags, Map<String, String> metadata, User owner) {
        ...
        private void createCertificates() {
                ...
                if (forscher != null) {
                        ...
                        certificates.add(createCertificate(forscher, Certificate.CertificateType.RESEARCH_UNIVERSITY,
                                        "Universitäts-Forschungszertifikat",
                                        "Allgemeine Forschungsberechtigung Universität Oldenburg",
                ...
                if (mediziner != null) {
                        certificates.add(createCertificate(mediziner, Certificate.CertificateType.RESEARCH_HEALTH,
                                        "Medizinische Forschungsberechtigung",
                                        "Dr. Sabine Weber - Epidemiologische Studien",
                ...
                if (umweltBehoerde != null) {
                        certificates.add(createCertificate(umweltBehoerde,
                                        Certificate.CertificateType.GOVERNMENT_ENVIRONMENT,
                                        "Behörden-Umweltzertifikat",
                                        "Dr. Anne Fischer - Niedersächsisches Umweltministerium",
                                        Certificate.Status.APPROVED, "gov_env_fischer_2024.pdf"));

                        certificates.add(createCertificate(umweltBehoerde,
                                        Certificate.CertificateType.GOVERNMENT_GENERAL,
                ...
                if (gesundheitsBehoerde != null) {
                        certificates.add(createCertificate(gesundheitsBehoerde,
                                        Certificate.CertificateType.GOVERNMENT_HEALTH,
                                        "Gesundheitsbehörden-Zertifikat",
                                        "Dr. Michael Bauer - Nds. Gesundheitsministerium",
                ...
                if (business != null) {
                        certificates.add(createCertificate(business, Certificate.CertificateType.BUSINESS_CONSULTING,
                                        "Beratungsunternehmen-Zertifikat",
                                        "Dr. Frank Zimmermann - Zertifizierte Datenanalyse",
                                        Certificate.Status.APPROVED, "business_consult_zimmermann_2024.pdf"));

                        certificates.add(createCertificate(business,
                                        Certificate.CertificateType.PROFESSIONAL_CONSULTANT,
                ...
                if (ngoUmwelt != null) {
                        certificates.add(createCertificate(ngoUmwelt, Certificate.CertificateType.NGO_ENVIRONMENTAL,
                                        "NGO Umweltschutz-Zertifikat",
                                        "Marina Janßen - NABU Ostfriesland Naturschutzarbeit",
                ...
                if (journalist != null) {
                        certificates.add(createCertificate(journalist,
                                        Certificate.CertificateType.PROFESSIONAL_JOURNALIST,
                ...
                if (energieBusiness != null) {
                        certificates.add(createCertificate(energieBusiness,
                                        Certificate.CertificateType.BUSINESS_ENVIRONMENTAL,
                                        "Energieunternehmen Umwelt-Zertifikat",
                                        "Ing. Petra Wolff - Enercon Umweltdatenanalyse",
                                        Certificate.Status.EXPIRED, "business_env_wolff_2023.pdf"));
                }

                certificateRepository.saveAll(certificates);
                System.out.println(
                                "✅ Created " + certificates.size() + " certificates with various statuses and types");
        }
        ...
        private Certificate createCertificate(User user, Certificate.CertificateType type, String fileName,
                ...
                cert.setUploadedAt(LocalDateTime.now().minusDays((long) (Math.random() * 90))); // Random date within
                                                                                                // last 90
                                                                                                // days

                if (status == Certificate.Status.APPROVED) {
                        cert.setReviewedAt(cert.getUploadedAt().plusDays((long) (Math.random() * 7 + 1))); // Reviewed
                                                                                                           // 1-7 days
                                                                                                           // after
                                                                                                           // upload
                        ...
                        cert.setReviewedBy("reviewer");
                        cert.setReviewNotes(
                                        "Zertifikat entspricht nicht den Anforderungen. Bitte korrektes Dokument einreichen.");
                }
        ...
        private DataRequest createDataRequest(String title, String description, Datasource.Category category,
                        ...
                        Datasource.DataFormat preferredFormat, String geographicScope, String timeScope,
                        String dataSize,
        ...
        private DataAccessRequest createAccessRequest(User user, Datasource datasource, Certificate certificate,
                ...
                request.setRequestedAt(LocalDateTime.now().minusDays((long) (Math.random() * 30))); // Within last 30
                                                                                                    // days
                ...
                switch (statusVariant) {
                        case 0: // APPROVED
                                ...
                                request.setReviewedAt(
                                                request.getRequestedAt().plusDays((long) (Math.random() * 5 + 1)));
                        ...
                        case 3: // REJECTED
                                ...
                                request.setReviewedAt(
                                                request.getRequestedAt().plusDays((long) (Math.random() * 7 + 2)));
                                request.setReviewedBy("reviewer");
        ...
        private String generateRequestReason(Datasource datasource, User user) {
                String[] reasons = {
                                "Für wissenschaftliche Auswertung im Rahmen meiner Forschungsarbeit zu "
                                                + datasource.getTitle(),
